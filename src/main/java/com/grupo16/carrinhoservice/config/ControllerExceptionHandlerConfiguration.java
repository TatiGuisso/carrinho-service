package com.grupo16.carrinhoservice.config;
...
import com.grupo16.carrinhoservice.exception.ExceptionJson;
...
public class ControllerExceptionHandlerConfiguration {
	...
	private static final String AUTH_EXCEPTION_HANDLER_ERROR_TO_RESOLVE_EXCEPTION = "carrinho.exceptionHandler.errorToResolveException";
	private static final String AUTH_ARGUMENT_NOT_VALID = "carrinho.argumentNotValid";
